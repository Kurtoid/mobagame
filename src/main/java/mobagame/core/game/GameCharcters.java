...
public class GameCharcters {
	...
	public final static Character reaper = new Character("reaper", "resources/Character/reaper.pmg", 1, 50, 20, 500, 20, 375,
			5, 25, 5, 25, 2, 10, 2, 10);//Still need to be balanced
	public final static Character jack = new Character("Jack", "", 150, 50, 20, 575, 25, 370, 7, 64, 0, 0, 5, 5, 7, 7);
