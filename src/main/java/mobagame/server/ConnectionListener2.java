...
public class ConnectionListener2 implements Runnable {
	...
	public ConnectionListener2(InetAddress hostAddress, int port, ResponseWorker worker) throws IOException {
	...
	public static void main(String[] args) {
		try {
			...
			new Thread(new ConnectionListener2(null, 8666, worker)).start();
